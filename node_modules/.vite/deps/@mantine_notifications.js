...
var Notifications = factory((_props, ref) => {
  ...
  const items = data.notifications.map(({ style: notificationStyle, ...notification }) => (0, import_jsx_runtime2.jsx)(
    Transition2,
    {
      timeout: duration,
  ...
  return (0, import_jsx_runtime2.jsx)(OptionalPortal, { withinPortal, ...portalProps, children: (0, import_jsx_runtime2.jsx)(Box, { ...getStyles("root"), ref, ...others, children: (0, import_jsx_runtime2.jsx)(TransitionGroup_default, { children: items }) }) });
});
